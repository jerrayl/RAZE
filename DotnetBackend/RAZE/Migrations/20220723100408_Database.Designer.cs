...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RAZE.Entities.Account", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("RAZE.Entities.Request", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RAZE.Entities.PlayerSession", b =>
                {
                    b.HasOne("RAZE.Entities.Account", "Account")
                        .WithMany()
            ...
            modelBuilder.Entity("RAZE.Entities.Request", b =>
                {
                    b.HasOne("RAZE.Entities.Account", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RAZE.Entities.Account", "Sender")
                        .WithMany()
